...
<Pic src={require('@site/static/img/elematilius_in_cave.png').default} title="Elematilius in Cave" fullWidth/>
...
<Pic src={require('@site/static/img/recipe/infusor.png').default} title="Recipe to Infusor" fullWidth/>

**Elematilius Potion**: Used on infusor to infuse it with elemental power.

<Pic src={'/img/recipe/elematilius_potion.png'} title="Elematilius Potion Recipe" fullWidth/>

**Seeds**: Any kind of seeds ![wheat seeds](/img/item/wheat_seeds.png), e.g. wheat seeds, melon seeds, pumpkin seeds, etc. We
...
<Pic src={'/img/recipe/croparia.png'} title="Croparia Recipe" fullWidth/>

As shown in REI (or JEI/EMI), we need to learn how to use the infusor.

1. Place the infusor on the ground.
<Pic src={'/img/place_infusor.png'} title="Place Infusor" fullWidth/>
2. Right click it with the elemental potion (Elematilius) to infuse it.
<Pic src={'/img/infuse_infusor.png'} title="Infuse Infusor" fullWidth/>
3. Right-click it with input items (seeds) or throw the input items onto the infusor to start the infusion.
<Pic src={'/img/infusor_place_item.png'} title="Place Items on Infusor" fullWidth/>

Now you have your first Croparia! You can use it to craft various crop seeds.

<Gallery pictures={[
    {
        src: require("@site/static/img/recipe/coal_seeds.png").default,
        title: "Coal Seeds Recipe"
    },
    {
        src: require("@site/static/img/recipe/leather_seeds.png").default,
...
<Pic src={'/img/recipe/elemental_stone.png'} title="Recipe to Elemental Stone" fullWidth/>
...
<Pic src={'/img/recipe/elemental_infusor.png'} title="Recipe to Infused Infusor" fullWidth/>
...
<Pic src={'/img/soak_place_elemental_stone.png'} title="Place Elemental Stone" fullWidth/>
2. Place an infusor on top of the elemental stone.
<Pic src={'/img/soak_place_infusor.png'} title="Place Infusor on Stone" fullWidth/>
3. Right click with an elemental potion to soak the infusor. In this case, we use an elematilius potion.
<Pic src={'/img/soak_infuse_infusor.png'} title="Soak Infusor" fullWidth/>
...
<Pic src={'/img/soak_place_input_block.png'} title="Place Input Block" fullWidth/>
5. Wait for a while, the input block (empty infusor) will transform into the output block (infused infusor) with a
"Ding" sound.
<Pic src={'/img/soak_output_block.png'} title="Output Block" fullWidth/>
...
<Pic src={require('@site/static/img/item/croparias.png').default} title="Croparia Variants" fullWidth/>

To upgrade croparia, you need different types of elemental potion. For example, t1 to t2 requires Potion of Earth.

<Pic src={'/img/recipe/croparia2.png'} title="Croparia Tier 2 Recipe" fullWidth/>

And to get Potion of Earth, you need to learn the **Ritual**, which is a multi-block structure used to perform rituals.

<Pic src={'/img/recipe/potion_earth.png'} title="Potion of Earth Recipe" fullWidth/>
...
<Pic src={'/img/recipe/ritual_stand.png'} title="Ritual Stand Recipe" fullWidth/>

**Some required blocks...**: You can check REI for the structure.

<Gallery pictures={[
    require("@site/static/img/recipe/ritual_1_1.png").default,
    require("@site/static/img/recipe/ritual_1_2.png").default,
    require("@site/static/img/recipe/ritual_1_3.png").default
]}/>

As texts are limited, please refer to REI for the exact structure. Or, in creative mode, you can check the structure by
sneaking & right-clicking the ritual stand with the Recipe Wizard.

<Gallery pictures={[
    require("@site/static/img/ritual_1_1.png").default,
    require("@site/static/img/ritual_1_2.png").default,
    require("@site/static/img/ritual_1_3.png").default
]}/>
...
<Pic src={'/img/ritual_place_input_block.png'} title="Place Input Block" fullWidth/>
2. Right-click the ritual stand with the input item (Elematilius), you will get the output item (Elemental Earth).
<Pic src={'/img/ritual_place_input_item.png'} title="Place Input Item" fullWidth/>
...
<Pic src={'/img/plant_seeds.png'} title="Plant Seeds" fullWidth/>

Croparia IF add **Greenhouse** block, which can boost the growth speed of crops (not only croparia crops) and
auto-harvest them.

<Gallery pictures={[
    require("@site/static/img/greenhouse_place.png").default,
    require("@site/static/img/greenhouse_container.png").default
]}/>
