...
<Pic src={require('@site/static/img/block/infusor.png').default} title="croparia:infusor" fullWidth/>
...
<Pic src={'/img/infuse_infusor.png'} title="Infused Infusor (Elemental)" fullWidth/>
...
<Pic src={'/img/recipe/croparia.png'} title="Example: Croparia T1" fullWidth/>
