...
<Gallery pictures={[
    {src: require("@site/static/img/block/ritual_stand.png").default, title: "croparia:ritual_stand"},
    {src: require("@site/static/img/block/ritual_stand_2.png").default, title: "croparia:ritual_stand_2"},
    {src: require("@site/static/img/block/ritual_stand_3.png").default, title: "croparia:ritual_stand_3"}
]}/>
...
<Gallery pictures={[
    {src: require("@site/static/img/recipe/ritual_stand.png").default, title: "croparia:ritual_stand"},
    {src: require("@site/static/img/recipe/ritual_stand_2.png").default, title: "croparia:ritual_stand_2"},
    {src: require("@site/static/img/recipe/ritual_stand_3.png").default, title: "croparia:ritual_stand_3"}
]}/>
...
- You need to read carefully by hovering your mouse over the blocks, as some blocks requires specific states.
  ...
  <Pic src={require("@site/static/img/recipe/ritual_1_2_coal.png").default}/>
- You might see barrier blocks ![Barrier](https://minecraft.wiki/images/BlockSprite_barrier.png?8d91a) in the structure
view, which means the positions can **ONLY** be air.
- You might see block with question mark
![Placeholder Item](https://github.com/MUYUTwilighter/croparia-if/blob/master/common/src/main/resources/assets/croparia/textures/item/placeholder.png?raw=true)
...
<Pic src={'/img/recipe/potion_earth.png'} title="Example: Potion of Earth" fullWidth/>
