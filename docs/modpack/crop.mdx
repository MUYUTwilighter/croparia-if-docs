...
You may try [Crop Creator](../playground/crop) to customize crops via the web app.
...
<del>Or, you can also duplicate a crop definition file, and set the `dependencies` to `{"disabled": ""}`.</del>
