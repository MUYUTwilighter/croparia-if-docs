...
path mentioned above. See details about the file types in the [Generator File Types](./spec_generators#supported-file-types) section.
...
Navigate to [Generator Creator](../../../playground/generator) to create the generator easily.
Note that you still need to test it in the game to ensure it works as expected.