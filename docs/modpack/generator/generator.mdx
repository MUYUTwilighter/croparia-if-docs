...
**NOTE**: DO NOT modify the contents except the `generators` folder in the file-pack directly, as pack handler will overwrite
the contents every time it is loaded.
...
Refer to the [Generator](./spec_generators) documentation for more details.
