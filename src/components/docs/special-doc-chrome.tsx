...
import { PageFooter, ResponsiveDebugPanel, SiteHeader } from "@/src/components/docs/chrome-shared";
      ...
      <Box component="main" sx={{ flex: 1, width: "100%" }}>
        <Box sx={{ py: { xs: 3, md: 5 } }}>
          <Stack spacing={3}>
            {showDebugPanel ? (
              <Box sx={{ px: { xs: 2, md: 4 } }}>
                <ResponsiveDebugPanel title={doc.frontmatter.title ?? "未知标题"} description={doc.frontmatter.desc}>
                  <Stack spacing={2.5}>
                    <Box>
