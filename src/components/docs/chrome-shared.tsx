...
export const docContentSx: SxProps<Theme> = {
  ...
  "& :not(pre) > code": {
    ...
    borderRadius: 1.5,
    border: "1px solid",
    borderColor: "rgba(127, 103, 76, 0.2)",
    bgcolor: "#f4ede2",
    color: "#5b4634",
    fontSize: "0.92em",
    fontWeight: 600,
  ...
  "& figure[data-rehype-pretty-code-figure]": {
    ...
    overflow: "hidden",
    border: "1px solid",
    borderColor: "rgba(91, 70, 52, 0.18)",
    backgroundColor: "#2a221c",
    boxShadow: "0 14px 28px rgba(32, 25, 16, 0.12)",
  },
  ...
  "& figure[data-rehype-pretty-code-figure] code[data-line-numbers] > [data-line]::before": {
    ...
    width: "2.5rem",
    mr: 2,
    color: "rgba(243, 234, 223, 0.36)",
    textAlign: "right",
  },
  "& figure[data-rehype-pretty-code-figure] [data-highlighted-line]": {
    backgroundColor: "rgba(255, 244, 229, 0.08)",
    borderLeft: "2px solid rgba(240, 219, 190, 0.42)",
  },
  "& figure[data-rehype-pretty-code-figure] mark[data-highlighted-chars]": {
    backgroundColor: "rgba(240, 219, 190, 0.18)",
    color: "inherit",
